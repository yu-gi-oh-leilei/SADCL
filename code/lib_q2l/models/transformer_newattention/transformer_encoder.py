...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        super().__init__()
        # self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout)  # nn.MultiheadAttention         
    ...
    def forward_post(self,
        ...
        src2 = self.self_attn(query=q, key=k, value=v, attn_mask=src_mask, 
