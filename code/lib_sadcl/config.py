...
def parser_args():
    available_models = ['SADCL-R50-448', 'SADCL-R101-448', 'SADCL-R101-512', 'SADCL-R101-576', 'SADCL-TResL-448', 'SADCL-TResL_22k-448', 'SADCL-TResL_22k-576', 'SADCL-SwinL-384', 'SADCL-CvT_w24-384']
    parser = argparse.ArgumentParser(description='Semantic-Aware Dual Contrastive Learning for Multi-label Image Classification')
    parser.add_argument('--dataname', help='dataname', default='coco14', choices=['coco14', 'voc2007', 'voc2012', 'nus_wide','nus_csv' , 'vg500'])
    parser.add_argument('--dataset_dir', help='dir of dataset', default='/media/data/maleilei/MLICdataset')
    parser.add_argument('--img_size', default=448, type=int,
                        help='size of input images')
    # prototype
    parser.add_argument('--prototype', help='dir of prototype', default='SADCL/data/prototype')
    ...
    parser.add_argument('--max_clip_grad_norm', default=10.0, type=float, 
                        metavar='M', help='max_clip_grad_norm')
    parser.add_argument('--epoch_step', default=[10, 20], type=int, nargs='+', 
                        help='number of epochs to change learning rate')  

    parser.add_argument('-a', '--arch', metavar='ARCH', default='SADCL-R101-448',
                        choices=available_models,
                        help='model architecture: ' +' | '.join(available_models) +
                            ' (default: SADCL-R101-448)')
