    ...
    with open(file, 'r') as f:
        ...
        for row in reader:
            if header and rownum == 0:
                ...
                images.append(item)
            rownum += 1
    # np.save('voc_all_labels.npy', all_label)
...
if __name__ == "__main__":
    ...
    # train_dataset = VOC2012(dataset_dir, phase='train', transform=None)
    # val_dataset = VOC2012(dataset_dir, phase='val', transform=None)
    # test_dataset = VOC2012(dataset_dir, phase='test', transform=None)

    dataset_dir = '/media/mlldiskSSD/MLICdataset/VOC2007'
    train_dataset = VOC2007(dataset_dir, phase='trainval', transform=None)
    # val_dataset = VOC2012(dataset_dir, phase='val', transform=None)
    test_dataset = VOC2007(dataset_dir, phase='test', transform=None)
